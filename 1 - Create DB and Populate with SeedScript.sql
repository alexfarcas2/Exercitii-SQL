...
/*CREATE TABLE Ingredients (
    ...
    OriginCountryID INT,
    DistributorID INT,
    FOREIGN KEY (OriginCountryID) REFERENCES Countries(CountryID),
    FOREIGN KEY (DistributorID) REFERENCES Distributors(DistributorID)
);*/

-- Create the ProductsIngredients mapping table
...
/*INSERT INTO Customers (CustomerID, FirstName, LastName, Gender, Age,PhoneNumber, CountryID) VALUES
...
/*INSERT INTO Distributors (DistributorID,Name,Summary,AddressText, CountryID) VALUES
...
/*INSERT INTO Products(ProductID, Name, Description, Recipe, Price) VALUES
...
/*INSERT INTO Feedbacks(FeedbackID,Description, Rate, ProductId, CustomerID) VALUES
...
/*INSERT INTO Ingredients (IngredientID, Name, Description, OriginCountryId, DistributorID) VALUES
